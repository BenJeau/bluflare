...
export const RootComponent: React.FC = () => {
  ...
  const page: Page | undefined = useMemo(() => {
    ...
    if (location.pathname.startsWith("/hashtags")) return "hashtags";
    if (location.pathname.startsWith("/urls")) return "urls";
                ...
                <Nav
                  links={[
                    ...
                    },
                    {
                      title: "urls",
                      to: "/urls",
                      variant: page === "urls" ? "default" : "ghost",
                      icon: LinkIcon,
                    },
                    {
                      title: "hashtags",
                      to: "/hashtags",
                      variant: page === "hashtags" ? "default" : "ghost",
                      icon: Hash,
                    },
                  ]}
                />
